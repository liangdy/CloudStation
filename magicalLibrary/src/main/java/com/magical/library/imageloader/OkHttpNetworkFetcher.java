...
/**
 * Project: TShow
 * FileName: OkHttpNetworkFetcher.java
 * Description:
 * Creator: ldy
...
public class OkHttpNetworkFetcher extends BaseNetworkFetcher<OkHttpNetworkFetcher.OkHttpNetworkFetchState> {
    ...
    public static class OkHttpNetworkFetchState extends FetchState {
        ...
        public OkHttpNetworkFetchState(Consumer<EncodedImage> consumer, ProducerContext context) {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    try {
                        ...
                        MagicalLog.w(TAG, "Exception when closing response body", e);
                    }
                }
            }
        });
