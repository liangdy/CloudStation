...
public class MagicalRecyclerView extends RecyclerView {
    ...
    private MagicalWrapRecyclerViewAdapter mWrapMagiclaRecyclerViewAdapter;
    ...
    public MagicalRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MagicalRecyclerView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.MagicalRecyclerView);
        mDefAllDivider = ta.getDrawable(R.styleable.MagicalRecyclerView_mrv_divider);
        mDefAllDividerHeight = (int) ta.getDimension(R.styleable.MagicalRecyclerView_mrv_dividerHeight, -1);
        mVerticalDivider = ta.getDrawable(R.styleable.MagicalRecyclerView_mrv_dividerVertical);
        mHorizontalDivider = ta.getDrawable(R.styleable.MagicalRecyclerView_mrv_dividerHorizontal);
        mVerticalDividerHeight = (int) ta.getDimension(R.styleable.MagicalRecyclerView_mrv_dividerVerticalHeight, -1);
        mHorizontalDividerHeight = (int) ta.getDimension(R.styleable.MagicalRecyclerView_mrv_dividerHorizontalHeight, -1);
        mItemViewBothSidesMargin = (int) ta.getDimension(R.styleable.MagicalRecyclerView_mrv_itemViewBothSidesMargin, 0);
        mEmptyViewResId = ta.getResourceId(R.styleable.MagicalRecyclerView_mrv_emptyView, -1);
        isKeepShowHeadOrFooter = ta.getBoolean(R.styleable.MagicalRecyclerView_mrv_isEmptyViewKeepShowHeadOrFooter, false);
        isHeaderDividersEnabled = ta.getBoolean(R.styleable.MagicalRecyclerView_mrv_headerDividersEnabled, false);
        isFooterDividersEnabled = ta.getBoolean(R.styleable.MagicalRecyclerView_mrv_footerDividersEnabled, false);
        isNotShowGridEndDivider = ta.getBoolean(R.styleable.MagicalRecyclerView_mrv_isNotShowGridEndDivider, false);
        if (ta.hasValue(R.styleable.MagicalRecyclerView_mrv_layoutManager)) {
            int layoutManagerType = ta.getInt(R.styleable.MagicalRecyclerView_mrv_layoutManager, DEF_LAYOUT_MANAGER_TYPE);
            int layoutManagerOrientation = ta.getInt(R.styleable.MagicalRecyclerView_mrv_layoutManagerOrientation, DEF_LAYOUT_MANAGER_ORIENTATION);
            boolean isReverseLayout = ta.getBoolean(R.styleable.MagicalRecyclerView_mrv_isReverseLayout, false);
            int gridSpanCount = ta.getInt(R.styleable.MagicalRecyclerView_mrv_spanCount, DEF_GRID_SPAN_COUNT);
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if (null == adapter) {
            if (null != mReqAdapter) {
                ...
                mReqAdapter = null;
                mWrapMagiclaRecyclerViewAdapter = null;
        ...
        mReqAdapter = adapter;
        mWrapMagiclaRecyclerViewAdapter = new MagicalWrapRecyclerViewAdapter(this, adapter, mHeaderView, mFooterView, mLayoutManagerType);

        mWrapMagiclaRecyclerViewAdapter.setOnItemClickListener(mTempOnItemClickListener);
        mWrapMagiclaRecyclerViewAdapter.setOnItemLongClickListener(mTempOnItemLongClickListener);
        mWrapMagiclaRecyclerViewAdapter.setOnHeadViewBindViewHolderListener(mTempOnHeadViewBindViewHolderListener);
        mWrapMagiclaRecyclerViewAdapter.setOnFooterViewBindViewHolderListener(mTempOnFooterViewBindViewHolderListener);

        mReqAdapter.registerAdapterDataObserver(mReqAdapterDataObserver);
        super.setAdapter(mWrapMagiclaRecyclerViewAdapter);

        if (needInitAddItemDescration && null != mDefaultItemDecoration) {
    ...
    private void initDefaultItemDecoration() {
        ...
        if (null != mDefaultItemDecoration) {
            super.removeItemDecoration(mDefaultItemDecoration);
            mDefaultItemDecoration = null;
        }
        ...
        mDefaultItemDecoration.setNotShowGridEndDivider(isNotShowGridEndDivider);
    ...
    private void processEmptyView() {
        if (null != mEmptyView) {
            ...
            if (isKeepShowHeadOrFooter) {
                if (hasShowEmptyView) {
                    mWrapMagiclaRecyclerViewAdapter.notifyItemRemoved(getHeaderViewsCount());
                }
            } else {
    ...
    public void setDivider(int height, Drawable divider) {
        ...
        if (null != mDefaultItemDecoration) {
            ...
            if (null != mWrapMagiclaRecyclerViewAdapter) {
                mWrapMagiclaRecyclerViewAdapter.notifyDataSetChanged();
            }
        }
    }
     ...
     */
    public void setOnHeadViewBindViewHolderListener(MagicalRecyclerView.OnHeadViewBindViewHolderListener onHeadViewBindViewHolderListener) {
        if (null != mWrapMagiclaRecyclerViewAdapter) {
            mWrapMagiclaRecyclerViewAdapter.setOnHeadViewBindViewHolderListener(onHeadViewBindViewHolderListener);
        } else {
     ...
     */
    public void setOnFooterViewBindViewHolderListener(MagicalRecyclerView.OnFooterViewBindViewHolderListener onFooterViewBindViewHolderListener) {
        if (null != mWrapMagiclaRecyclerViewAdapter) {
            mWrapMagiclaRecyclerViewAdapter.setOnFooterViewBindViewHolderListener(onFooterViewBindViewHolderListener);
        } else {
    ...
    public void addHeaderView(View v, boolean isScrollTo) {
        ...
        if (null != mWrapMagiclaRecyclerViewAdapter) {
            ...
            mWrapMagiclaRecyclerViewAdapter.notifyItemInserted(pos);
    ...
    public boolean removeHeaderView(View v) {
        ...
        if (null != mWrapMagiclaRecyclerViewAdapter) {
            mWrapMagiclaRecyclerViewAdapter.notifyItemRemoved(mHeaderView.indexOf(v));
        }
    ...
    public boolean removeFooterView(View v) {
        ...
        if (null != mWrapMagiclaRecyclerViewAdapter) {
            ...
            mWrapMagiclaRecyclerViewAdapter.notifyItemRemoved(pos);
        }
    ...
    public void setOnItemClickListener(OnItemClickListener listener) {
        if (null == mWrapMagiclaRecyclerViewAdapter) {
            ...
            mWrapMagiclaRecyclerViewAdapter.setOnItemClickListener(listener);
        }
    }
    ...
    public void setOnItemLongClickListener(OnItemLongClickListener listener) {
        if (null == mWrapMagiclaRecyclerViewAdapter) {
            ...
            mWrapMagiclaRecyclerViewAdapter.setOnItemLongClickListener(listener);
        }
    }

    public interface OnItemClickListener {
        void onItemClick(MagicalRecyclerView magicalRecyclerView, View view, int position);
    }

    public interface OnItemLongClickListener {
        boolean onItemLongClick(MagicalRecyclerView magicalRecyclerView, View view, int position);
    }
    ...
    private AdapterDataObserver mReqAdapterDataObserver = new AdapterDataObserver() {
        ...
        public void onItemRangeInserted(int positionStart, int itemCount) {
            mWrapMagiclaRecyclerViewAdapter.notifyItemInserted(getHeaderViewsCount() + positionStart);
            processEmptyView();
        }

        public void onItemRangeRemoved(int positionStart, int itemCount) {
            mWrapMagiclaRecyclerViewAdapter.notifyItemRemoved(getHeaderViewsCount() + positionStart);
            processEmptyView();
        }

        @Override
        public void onItemRangeChanged(int positionStart, int itemCount) {
            mWrapMagiclaRecyclerViewAdapter.notifyItemRangeChanged(getHeaderViewsCount() + positionStart, itemCount);
            processEmptyView();
        }

        @Override
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
            mWrapMagiclaRecyclerViewAdapter.notifyItemMoved(getHeaderViewsCount() + fromPosition, getHeaderViewsCount() + toPosition);
        }
    };
