...
public class MagicalWrapRecyclerViewAdapter extends RecyclerView.Adapter implements View.OnClickListener, View.OnLongClickListener {
    ...
    private MagicalRecyclerView.OnItemClickListener mOnItemClickListener;
    private MagicalRecyclerView.OnItemLongClickListener mOnItemLongClickListener;
    private MagicalRecyclerView mMagicalRecyclerView;
    private long mLastClickTime;
    private MagicalRecyclerView.OnHeadViewBindViewHolderListener mOnHeadViewBindViewHolderListener;
    private MagicalRecyclerView.OnFooterViewBindViewHolderListener mOnFooterViewBindViewHolderListener;
    private List<Integer> mHeadOrFooterInitInvokeViewBindViewFlag = new ArrayList<>();

    public MagicalWrapRecyclerViewAdapter(MagicalRecyclerView magicalRecyclerView, RecyclerView.Adapter reqAdapter, List<View> mHeaderView, List<View> mFooterView, int layoutManagerType) {
    ...
    public int getItemCount() {
        ...
        if (mMagicalRecyclerView.isKeepShowHeadOrFooter()) {
    ...
    public int getItemViewType(int position) {
        ...
        } else if (mMagicalRecyclerView.isKeepShowHeadOrFooter()) {
            // empty view
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_HEADER: {
                ...
                if (mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID) {
            ...
            case VIEW_TYPE_EMPTY_VIEW: {
                ...
                View emptyView = mMagicalRecyclerView.getEmptyView();
    ...
    public void setOnItemClickListener(MagicalRecyclerView.OnItemClickListener mOnItemClickListener) {
        this.mOnItemClickListener = mOnItemClickListener;
    }

    public void setOnItemLongClickListener(MagicalRecyclerView.OnItemLongClickListener mOnItemLongClickListener) {
    ...
    public void onClick(View v) {
        ...
        if (null != mOnItemClickListener && curTime - mLastClickTime > MIN_INTERVAL_CLICK_TIME) {
            ...
            mOnItemClickListener.onItemClick(mMagicalRecyclerView, v, mMagicalRecyclerView.getChildAdapterPosition(v) - mMagicalRecyclerView.getHeaderViewsCount());
        }
    }
    ...
    public boolean onLongClick(View v) {
        ...
        if (null != mOnItemClickListener && curTime - mLastClickTime > MIN_INTERVAL_CLICK_TIME) {
            mLastClickTime = curTime;
            return mOnItemLongClickListener.onItemLongClick(mMagicalRecyclerView, v, mMagicalRecyclerView.getChildAdapterPosition(v) - mMagicalRecyclerView.getHeaderViewsCount());
        }
        return false;
    }

    public void setOnHeadViewBindViewHolderListener(MagicalRecyclerView.OnHeadViewBindViewHolderListener mOnHeadViewBindViewHolderListener) {
        this.mOnHeadViewBindViewHolderListener = mOnHeadViewBindViewHolderListener;
    }

    public void setOnFooterViewBindViewHolderListener(MagicalRecyclerView.OnFooterViewBindViewHolderListener mOnFooterViewBindViewHolderListener) {
