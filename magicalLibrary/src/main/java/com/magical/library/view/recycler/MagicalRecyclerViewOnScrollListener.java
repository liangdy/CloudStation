...
public abstract class MagicalRecyclerViewOnScrollListener extends RecyclerView.OnScrollListener {
    ...
    public MagicalRecyclerViewOnScrollListener(RecyclerView.LayoutManager layoutManager) {
