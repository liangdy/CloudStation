...
/**
 * Project: TShow
 * FileName: FilletBtView.java
 * Description:
 * Creator: ldy
 * Email: 1020118243@qq.com
 * Crete Date: 9/27/16 12:01 AM
 * Editor: ldy
 * Modify Date: 9/27/16 12:01 AM
 * Remark:
 */
public class FilletBtView extends TextView {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        TypedArray a = getContext()
                .obtainStyledAttributes(attrs, R.styleable.FilletBtView, defStyle, 0);
        fillet = a.getDimension(R.styleable.FilletBtView_fillet, fillet);
        defaultColor = a
                .getColor(R.styleable.FilletBtView_defaultColor, getResources()
                        .getColor(R.color.blue_3eabfe));
        pressedColor = a
                .getColor(R.styleable.FilletBtView_pressedColor, getResources()
                        .getColor(R.color.blue_1E90FF));
        a.recycle();
