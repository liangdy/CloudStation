...
public class DefaultItemDecoration extends RecyclerView.ItemDecoration {
    private MagicalRecyclerView mMagicalRecyclerView;
    ...
    private int mLayoutManagerType = MagicalRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR;
    ...
    public DefaultItemDecoration(MagicalRecyclerView magicalRecyclerView, Drawable dividerVertical, Drawable dividerHorizontal, int dividerDrawableSizeVertical, int dividerDrawableSizeHorizontal) {
        this.mMagicalRecyclerView = magicalRecyclerView;
    ...
    private void initLayoutManagerType() {
        this.mLayoutManagerType = mMagicalRecyclerView.getCurLayoutManagerType();
        RecyclerView.LayoutManager layoutManager = mMagicalRecyclerView.getLayoutManager();
        switch (mLayoutManagerType) {
            case MagicalRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR:
                ...
                break;
            case MagicalRecyclerView.LAYOUT_MANAGER_TYPE_GRID:
                ...
                break;
            case MagicalRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID:
                ...
                break;
            default:
                this.mLayoutManagerType = MagicalRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR;
        }
    ...
    private void drawDividerDrawable(Canvas c, RecyclerView parent) {
        ...
        MagicalRecyclerView curMagicalRecyclerView = null;
        if (parent instanceof MagicalRecyclerView) {
            curMagicalRecyclerView = (MagicalRecyclerView) parent;
            headersCount = curMagicalRecyclerView.getHeaderViewsCount();
            footerCount = curMagicalRecyclerView.getFooterViewsCount();
            itemViewCount = curMagicalRecyclerView.getAdapter().getItemCount() - headersCount - footerCount;
        } else {
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR
            ...
            boolean isEmptyView = isEmptyView(curMagicalRecyclerView, position, headersCount);
            ...
            switch (mLayoutManagerType) {
                ...
                case MagicalRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID:
                    ...
                    if (mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_GRID && position == (itemViewCount + headersCount - 1)) {
                    ...
                    if (mOrientation == OrientationHelper.HORIZONTAL) {
                        ...
                        if (!isNotShowGridEndDivider || (!isGridLayoutLastNum && !isGridItemLayoutLastColumn)) {
                            ...
                            if (mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID && !isGridItemLayoutLastRow) {
                        ...
                        if (isGridItemLayoutFirstRow) {
                        ...
                        } else if (mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_GRID && isGridItemLayoutLastRow) {
                            ...
                            if (mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_GRID && !isGridItemLayoutLastColumn) {
                        ...
                        if (!isNotShowGridEndDivider || (!isGridItemLayoutLastColumn
                                && ((mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_GRID && !isGridLayoutLastNum)
                                || mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID))) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (isHeadViewPos(headersCount, position)) {
            ...
            return ;
        } else if (isEmptyView(curMagicalRecyclerView, position, headersCount)) {
            // emptyView
        ...
        // set itemView
        if (mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_GRID || mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID) {
    ...
    private void processGridOffsets(Rect outRect, int position, int headersCount, View view) {
        int curGridNum;
        if (mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_GRID) {
    ...
    private boolean isEmptyView(MagicalRecyclerView magicalRecyclerView, int position, int headersCount) {
        if (null != magicalRecyclerView && magicalRecyclerView.isKeepShowHeadOrFooter()
                && magicalRecyclerView.isShowEmptyView() && position == headersCount) {
            return true;
        }
    ...
    private boolean isGridItemLayoutLastRow(int position, int itemViewCount, int headersCount) {
        if (mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_LINEAR) return false;
    ...
    private boolean isGridItemLayoutLastColumn(int position, int headersCount, View view) {
        ...
        } else if (mLayoutManagerType == MagicalRecyclerView.LAYOUT_MANAGER_TYPE_STAGGERED_GRID) {
