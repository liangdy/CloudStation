...
public class ScreenUtils {
     ...
     * @return
     */
    public static int getStatusHeight(Activity activity) throws IllegalArgumentException {
        int statusHeight = 0;
        ...
        if (0 == statusHeight) {
            ...
            } catch (ClassNotFoundException | IllegalAccessException | NumberFormatException | InstantiationException | SecurityException | NoSuchFieldException e) {
                e.printStackTrace();
            }
        }
        return statusHeight;
